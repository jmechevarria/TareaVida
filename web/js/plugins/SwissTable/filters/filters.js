...
(function($, window, document, undefined) {
    ...
    var $this;
    var pluginName = 'TableFilters';

    // Create the plugin constructor
    function _construct(element, options) {
        this.element = element;
        this._name = pluginName;
        this._defaults = $.fn.TableFilters.defaults;
    ...
    $.extend(_construct.prototype, {
        init: function() {
            ...
            this.$element.addClass('table-filtered');
...
//            console.log(this.rowBeforeFilters.parent());
...
//            });
    ...
    $.fn.TableFilters = function(options) {
        this.each(function() {
    ...
    $.fn.TableFilters.defaults = {
        rowBeforeFilters: 0,
        filterUpTo: 999999,
        withOptions: true,
        appendAmountTo: null,
        onComplete: null,
//        filtersRowBackground: {
//            color: 'lightgreen',
//            image: 'none',
//            repeat: 'repeat',
//            attachment: 'scroll',
